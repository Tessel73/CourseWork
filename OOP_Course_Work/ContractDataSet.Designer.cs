...
namespace OOP_Course_Work {
    ...
    public partial class ContractDataSet : global::System.Data.DataSet {
        ...
        public partial class ContractDataTable : global::System.Data.TypedTableBase<ContractRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ContractRow AddContractRow(int ClientID, int TurID, int HotelID, int Number, double Cost, double TotalCost) {
        ...
        public partial class ContractRow : global::System.Data.DataRow {
            ...
            public int TurID {
                get {
                    return ((int)(this[this.tableContract.TurIDColumn]));
                }
                set {
            ...
            public int HotelID {
                get {
                    return ((int)(this[this.tableContract.HotelIDColumn]));
                }
                set {
...
namespace OOP_Course_Work.ContractDataSetTableAdapters {
    ...
    public partial class ContractTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Contract] WHERE (([ContractID] = @Original_ContractID) AND ([ClientID] = @Original_ClientID) AND ([TurID] = @Original_TurID) AND ([HotelID] = @Original_HotelID) AND ([Number] = @Original_Number) AND ([Cost] = @Original_Cost) AND ((@IsNull_TotalCost = 1 AND [TotalCost] IS NULL) OR ([TotalCost] = @Original_TotalCost)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contract] SET [ClientID] = @ClientID, [TurID] = @TurID, [HotelID] = @HotelID, [Number] = @Number, [Cost] = @Cost, [TotalCost] = @TotalCost WHERE (([ContractID] = @Original_ContractID) AND ([ClientID] = @Original_ClientID) AND ([TurID] = @Original_TurID) AND ([HotelID] = @Original_HotelID) AND ([Number] = @Original_Number) AND ([Cost] = @Original_Cost) AND ((@IsNull_TotalCost = 1 AND [TotalCost] IS NULL) OR ([TotalCost] = @Original_TotalCost)));
SELECT ContractID, ClientID, TurID, HotelID, Number, Cost, TotalCost FROM Contract WHERE (ContractID = @ContractID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContractID, ClientID, TurID, HotelID, Number, Cost, TotalCost FROM dbo.Con" +
                "tract";
        ...
        public virtual int Delete(int Original_ContractID, int Original_ClientID, int Original_TurID, int Original_HotelID, int Original_Number, double Original_Cost, global::System.Nullable<double> Original_TotalCost) {
            ...
            if ((Original_TotalCost.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[7].Value = ((double)(Original_TotalCost.Value));
            }
            else {
        ...
        public virtual int Update(int ClientID, int TurID, int HotelID, int Number, double Cost, global::System.Nullable<double> TotalCost, int Original_ContractID, int Original_ClientID, int Original_TurID, int Original_HotelID, int Original_Number, double Original_Cost, global::System.Nullable<double> Original_TotalCost, int ContractID) {
            ...
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_TurID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ClientID, int TurID, int HotelID, int Number, double Cost, global::System.Nullable<double> TotalCost, int Original_ContractID, int Original_ClientID, int Original_TurID, int Original_HotelID, int Original_Number, double Original_Cost, global::System.Nullable<double> Original_TotalCost) {
            return this.Update(ClientID, TurID, HotelID, Number, Cost, TotalCost, Original_ContractID, Original_ClientID, Original_TurID, Original_HotelID, Original_Number, Original_Cost, Original_TotalCost, Original_ContractID);
        }
    }
