...
namespace OOP_Course_Work {
    ...
    public partial class HotelDataSet : global::System.Data.DataSet {
        ...
        public partial class HotelDataTable : global::System.Data.TypedTableBase<HotelRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public HotelRow AddHotelRow(string Name, int Rating, double Cost) {
...
namespace OOP_Course_Work.HotelDataSetTableAdapters {
    ...
    public partial class HotelTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Hotel] ([Name], [Rating], [Cost]) VALUES (@Name, @Rating, @Cos" +
                "t);\r\nSELECT HotelID, Name, Rating, Cost FROM Hotel WHERE (HotelID = SCOPE_IDENTI" +
                "TY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Hotel] SET [Name] = @Name, [Rating] = @Rating, [Cost] = @Cost WHERE (([HotelID] = @Original_HotelID) AND ((@IsNull_Rating = 1 AND [Rating] IS NULL) OR ([Rating] = @Original_Rating)) AND ([Cost] = @Original_Cost));
SELECT HotelID, Name, Rating, Cost FROM Hotel WHERE (HotelID = @HotelID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT HotelID, Name, Rating, Cost FROM dbo.Hotel";
        ...
        public virtual int Insert(string Name, global::System.Nullable<int> Rating, double Cost) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, global::System.Nullable<int> Rating, double Cost, int Original_HotelID, global::System.Nullable<int> Original_Rating, double Original_Cost, int HotelID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, global::System.Nullable<int> Rating, double Cost, int Original_HotelID, global::System.Nullable<int> Original_Rating, double Original_Cost) {
            return this.Update(Name, Rating, Cost, Original_HotelID, Original_Rating, Original_Cost, Original_HotelID);
        }
    }
